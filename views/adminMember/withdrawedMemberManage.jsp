...
>
  <head>
    ...
    <title>weaRit 관리자모드 - 탈퇴회원관리</title>
    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">회원 관리/</span> 탈퇴 회원 관리</h4>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">탈퇴일</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                          	<select name="searchCondition" class="form-select" style="width:200px">
                          	  <option value="withdrawed_id">아이디</option>
                          	  <option value="withdrawed_reason">탈퇴 사유</option>
                          	</select>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="inputKeyword" class="form-control" placeholder="검색어를 입력하세요."/>
                          </div>
                        </div>
                      </div>
                      <hr/>
                        ...
                        <tr>
                    	  <td align="right" style="padding:0px 15px 15px 0px;">
                            ...
                            <button type="submit" class="btn btn-primary"
                            		onclick="javascript: form.action='withdrawedMemberManage';">검색</button>
                          </td>
                        </tr>
                      </table>
                    </div>
                    ...
                    <div class="card-body" style="overflow-x:auto; overflow-y:auto;">
                      <table class="table table-bordered table_set" id="listTable">
                        ...
                        <tbody>
                          <c:forEach items="${withdrawedMemberList }" var="MemberVO">
                          <tr>
                        	<td><input class="form-check-input" type="checkbox"></td>
                        	<td>${MemberVO.withdrawedId }</td>
                        	<td>${MemberVO.withdrawedDate }</td>
                        	<td>${MemberVO.withdrawedReason }</td>
                          </tr>
                          </c:forEach>
                        </tbody>
                      </table>
