...
<body class="animsition">
	...
	<section class="bg0 p-t-104 p-b-116">
						...
						<h4 class="mtext-104 cl2 txt-center p-b-30">
							문의에 대한 답변은 마이페이지에서 확인 가능하십니다.
						</h4>
						<h4 class="mtext-104 cl2 txt-center p-b-30">
							아래 버튼을 클릭하시면 메인 페이지로 이동합니다.
						</h4>
						</div>
						<hr style="visibility:hidden">
						<div style="width:170px; margin:auto; display:block;">
						<a href="index.do">
						  <input type="button" value="메인페이지로 이동" class="flex-c-m stext-103 cl0 size-127 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
						</a>
						</div>
	</section>	
