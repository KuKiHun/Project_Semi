				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="insertInquiry" method="post">
						...
						<div class="m-b-20 how-pos4-parent">
							<select class="form-select p-lr-28" name="bono">
								<option value="4">회원/멤버십</option>
								<option value="5">주문/결제</option>
								<option value="6">배송문의</option>
								<option value="7">취소/교환/환불</option>
								<option value="8">사이트 이용 오류/개선</option>
							</select>
						</div>
						
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-lr-28" type="text" name="inquiryTitle" placeholder="제목을 입력하세요.">
						</div>

						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="inquiryContent" placeholder="문의내용을 입력해주세요.(2000자 이내)"></textarea>
						</div>

						<input type="submit" value="문의하기" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
