...
<body class="animsition">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						<a href="login.jsp" class="flex-c-m trans-04 p-lr-25"> 로그아웃 </a> <a
	...
	<!-- Content page -->
	<section
		class="bg0 p-t-104 p-b-116 d-flex justify-content-center align-items-center">

		<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
			<form>
				<h4 class="mtext-105 cl2 txt-center p-b-30">개인정보수정</h4>


				<div class="bor8 m-b-20 how-pos4-parent">
					<input class="stext-111 cl2 plh3 size-121 
							 p-l-15 p-r-20"
						id="userid" type="text" name="userid" value="고정된 아이디값">
				</div>
				...
				<div class="bor8 m-b-30">
					<input class="stext-111 cl2 plh3 size-121
						...
						placeholder="비밀번호를 입력해 주세요"></input>
				</div>
				<div class="bor8 m-b-30">
					<input class="stext-111 cl2 plh3 size-121
							 p-l-15 p-r-20"
						id="new_password" type="password" name="new_password"
						placeholder="새 비밀번호를 입력해 주세요"></input>
				</div>
				<div class="bor8 m-b-30">
					<input class="stext-111 cl2 plh3 size-121
							 p-l-15 p-r-20"
						id="comfirm_password" type="password" name="comfirm_password"
						placeholder="새 비밀번호를 다시 입력해 주세요"></input>
				</div>
				<div class="bor8 m-b-30">
					<input class="stext-111 cl2 plh3 size-121
							 p-l-15 p-r-20"
						id="username" type="text" name="username"
						placeholder="홍길동"></input>
				</div>
				<div class="bor8 m-b-30">
					<input class="stext-111 cl2 plh3 size-121
							 p-l-15 p-r-20"
						id="email" type="email" name="password"
						placeholder="qwer1234@naver.com"></input>
				</div>
				<div class="bor8 m-b-30">
					<input class="stext-111 cl2 plh3 size-121
							 p-l-15 p-r-20"
						id="tel" type="text" name="tel"
						placeholder="01012345678"></input>
				</div>
				
			<div class="bor8 m-b-20 how-pos4-parent">
                <label for="male" class="stext-111 cl2">성별: </label>
                <input type="radio" id="male" name="gender" value="male"> 남자<input type="radio" id="female" name="gender" value="female"> 여자
            </div>
					
        		 <div class="bor8 m-b-30">
              	   <label for="dob" class="stext-111 cl2">생년월일: </label>
             	   <input class="stext-111 cl2 plh3 size-121 p-l-15 p-r-20" id="dob" type="date" name="birthdate">
        	 	 </div>
        	 	 
        	 	<button id="updateButton" class="flex-c-m stext-101 cl0 size-121 bg3 bor hov-btn3 p-lr-15 trans-04 pointer" src="index.jsp">회원정보수정</button> 
			</form>
		</div>
