...
<body class="animsition">
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li><a href="product.do">구매</a></li>

							<li class="label1" data-label1="hot"><a
								href="shoping-cart.do">렌탈</a></li>

							<li><a href="blog.do">룩북</a></li>

							<li><a href="about.do">이용방법안내</a></li>

							<li><a href="contact.do">커뮤니티 </a></li>
						</ul>
					</div>
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" id="bgimage"
		...
		<h2 class="ltext-105 cl0 txt-center">로그아웃</h2>
	</section>
	...
	<section class="bg0 p-t-104 p-b-116">
		...
		<h4 class="mtext-105 cl2 txt-center p-b-30">로그아웃 되었습니다.</h4>
		<h4 class="logo">
