...
>
  <head>
    ...
    <title>weaRit 관리자모드 - 전체주문조회</title>
    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">주문 관리/</span> 전체 주문 조회</h4>
...
<%@ include file="/WEB-INF/views/fix/footer.jsp" %>
	...
	<script src="/zWeaRit/resources/js/admin/adminOrder.js"></script>
	</form>
  </body>
</html>
