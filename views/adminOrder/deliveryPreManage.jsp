    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">주문 관리/</span> 발주 관리</h4>
                ...
                <div class="col-xxl">
                        ...
                        <tr>
                    	  <td align="right" style="padding:0px 15px 15px 0px;">
                            ...
                            <button type="submit" class="btn btn-primary"
                            		onclick="javascript: form.action='deliveryPreManage';">검색</button>
                          </td>
                        </tr>
                      </table>
                    </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-header d-flex">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <button type="submit" value="preOk" class="btn btn-xs btn-info"
                      		  onclick="javascript: form.action='deliveryPreOk';">발주완료 처리</button>&nbsp;
                    </div>
                    <div class="card-body" style="overflow-x:auto; overflow-y:auto;">
                      <table class="table table-bordered table_set" id="listTable">
                        ...
                        <tbody>
                          <c:forEach items="${deliveryPreList }" var="list">
                          <tr>
                        	<td><input class="form-check-input" type="checkbox" name="checkedOno" value="${list.ono }"></td>
                        	<td>${list.ono }</td>
                        	<td>${list.orderedType }</td>
                        	<td>${list.orderedDate }</td>
                        	<td>${list.orderedName }</td>
                        	<td>${list.orderedAmount }</td>
                        	<td>${list.orderedPrice }</td>
