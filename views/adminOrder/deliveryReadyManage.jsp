...
>
  <head>
    ...
    <title>weaRit 관리자모드 - 배송준비중관리</title>
    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">주문 관리/</span> 배송 준비 중 관리</h4>
                        ...
                        <tr>
                    	  <td align="right" style="padding:0px 15px 15px 0px;">
                            ...
                            <button type="submit" class="btn btn-primary"
                            		onclick="javascript: form.action='deliveryReadyManage';">검색</button>
                          </td>
                        </tr>
                      </table>
                    </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-header d-flex">
                      ...
                      <button type="submit" class="btn btn-xs btn-info"
                      		  onclick="javascript: form.action='deliveryReadyOk';">주문완료 처리</button>&nbsp;
                      <button type="submit" class="btn btn-xs btn-secondary"
                      		  onclick="javascript: form.action='trackingNumSave';">송장번호 저장</button>&nbsp;
                      <button type="submit" class="btn btn-xs btn-secondary"
                      		  onclick="javascript: form.action='deliveryReadyYet';">배송보류 처리</button>&nbsp;
                    </div>
                    <div class="card-body" style="overflow-x:auto; overflow-y:auto;">
                      <table class="table table-bordered table_set" id="listTable">
                        ...
                        <tbody>
                         <c:forEach items="${getDeliveryReadyList }" var="list">
                          <tr>
                        	<td><input class="form-check-input" type="checkbox" id="checkedOno" name="checkedOno" value="${list.ono }"></td>
                        	<td>${list.ono }</td>
                        	<td>${list.orderedType }</td>
                        	<td>${list.orderedDate } (${list.payDate })</td>
                        	<td>${list.memberName }</td>
                        	<td><input type="text" name="trackingNum" value="${list.trackingNum }"></td>
                        	<td><input type="text" name="supplier" value="${list.supplier }"></td>
                        	<td>${list.orderedName }</td>
                        	<td>${list.orderedAmount }</td>
                        	<td>${list.payPrice }</td>
                        	<td>${list.note }</td>
                          </tr>
                         </c:forEach>
