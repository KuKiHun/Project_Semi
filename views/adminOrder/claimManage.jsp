...
>
  <head>
    ...
    <title>weaRit 관리자모드 - 클레임관리</title>
    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">주문 관리/</span> 클레임 관리</h4>
                        ...
                        <tr>
                    	  <td align="right" style="padding:0px 15px 15px 0px;">
                            ...
                            <button type="submit" class="btn btn-primary"
                            		onclick="javascript: form.action='claimManage';">검색</button>
                          </td>
                        </tr>
                      </table>
                    </div>
