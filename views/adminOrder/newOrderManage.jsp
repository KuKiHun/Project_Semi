...
>
  <head>
    ...
    <title>weaRit 관리자모드 - 신규주문관리</title>
    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">주문 관리/</span> 신규 주문 관리</h4>
                ...
                <div class="col-xxl">
                      ...
                      <table>
                        <tr>
                    	  <td align="right" style="padding:0px 15px 15px 0px;">
                            ...
                            <button type="submit" value="searchOk" class="btn btn-primary"
                            		onclick="javascript: form.action='newOrderManage';">검색</button>
                          </td>
                        </tr>
                      </table>
                    </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-header d-flex">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <button type="submit" value="paymentOk" class="btn btn-xs btn-info"
                      		  onclick="javascript: form.action='paymentOk';">입금확인 처리</button>&nbsp;
                      <button type="submit" value="orderCancel" class="btn btn-xs btn-danger"
                      		  onclick="javascript: form.action='orderCancel';">주문취소 처리</button>&nbsp;
                    </div>
                    <div class="card-body" style="overflow-x:auto; overflow-y:auto;">
                      <table class="table table-bordered table_set" id="listTable">
                        ...
                        <tbody>
                          <c:forEach items="${newOrderList }" var="list">
							<tr>
								<td><input type="checkbox" class="form-check-input" name="checkedOno" value="${list.ono }"></td>
								<td>${list.ono }</td>
								<td>${list.orderedType }</td>
								<td>${list.orderedDate }</td>
