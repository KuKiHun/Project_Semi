...
>
  <head>
    ...
    <title>weaRit 관리자모드 - 배송중관리</title>
    ...
    <%@ include file="/WEB-INF/views/fix/header.jsp" %>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">주문 관리/</span> 배송 중 관리</h4>
                ...
                <div class="col-xxl">
                        ...
                        <tr>
                    	  <td align="right" style="padding:0px 15px 15px 0px;">
                            ...
                            <button type="submit" class="btn btn-primary"
                            		onclick="javascript: form.action='deliveryIngManage';">검색</button>
                          </td>
                        </tr>
                      </table>
                    </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-header d-flex">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <button type="button" class="btn btn-xs btn-info">배송완료 처리</button>&nbsp;
                      <button type="button" class="btn btn-xs btn-secondary">배송대기 처리</button>&nbsp;
                      <button type="button" class="btn btn-xs btn-secondary">배송준비중 처리</button>&nbsp;
                    </div>
                      ...
                      <table class="table table-bordered table_set" id="listTable">
                        ...
                        <tbody>
                          <tr>
                        	...
                        	<td>2023-10-31 / 1234567890</td>
                        	<td>홍길동</td>
                        	<td>23-11-01 / 998877998877</td>
                        	<td>334411225566(23-11-01)</td>
                        	<td>CJ대한통운</td>
                        	<td>만오천원짜리물건/M</td>
                        	<td>첫 손님</td>
                          </tr>
