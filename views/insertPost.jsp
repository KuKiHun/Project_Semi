...
<!-- Header -->
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" id="bgimage" style="background-image: url('resources/images/bg-01.jpg');">
		...
		<hr>
		<!-- 1. 폼태그에 속성 추가  -->
		<form action="savePost.do" method="post" > <!-- enctype="multipart/form-data" -->
		<!-- 타입 중 file이 껴있으면 반드시 method가 get이 아닌 post 사용 -->
			<table border="1" class="table table-bordered">
				<!-- 2. 각 항목에  name 맞추기 -->
				<tr>
					<td bgcolor="#DCD3CB" width="100">제목</td>
					<td align="left"><input type="text" name="postTitle" value="${post.postTitle }"/></td>
				</tr>
				<!-- 히든으로 안보이게  name ="mno" value="회원이가진 mno값으로 채워서 같이 날려주면되지"-->
				<tr>
					<td bgcolor="#DCD3CB">작성자</td>
					<td align="left"><input type="text" size="10" name="postWriter" value=" ${post.postWriter }" ></td>
				</tr>
				<tr>
					<td bgcolor="#DCD3CB">내용</td>
					<td align="left"><textarea cols="100" rows="10" name="postContent" value="${post.postContent }" > </textarea></td>
				</tr>
				<!-- 추가항목 시작 -->
				
				<tr>
					<td bgcolor="#DCD3CB">비밀번호</td>
					<td align="left"><input type="text" name="postPass" value="${post.postPass }"></td>
				</tr>
				 <tr>
					<td bgcolor="#DCD3CB" width="70" value="${post.postFileaddr } "> 파일추가 </td><td align="left">
