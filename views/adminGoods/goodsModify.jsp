                    ...
                    <div class="card-body">
                      <input type="hidden" name="gno" value="${goods.gno}" />
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="brandName" name="brandName" value="${goods.brandName }"/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="goodsStock">재고</label>
                          <div class="col-sm-10">
                            <input type="text" id="goodsStock" name="goodsStock" class="form-control" style="width:150px" value="${goods.goodsStock }" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textArea id="goodsDescription" name="goodsDescription" class="form-control" style="height:150px" >${goods.goodsDescription }</textArea>
                          </div>
                        </div>
                       </div>
                        <hr/>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textArea id="tags" name="tags" class="form-control" style="height:150px">${goods.tags }</textArea>
                            ...
                            <tr>
                              ...
                              <td style="padding:0px 30px 30px 30px">
                                ...
                                <input id="marginPct" 
                                	   ...
                                	   class="form-control" 
                                	   style="width:100px" 
                                	   value="${goods.marginPct }">
                                <span class="input-group-text">%</span>
                                </div>
                              </td>
                              <td style="padding:0px 30px 30px 30px">
                                <div class="input-group input-group-merge">
                                <input id="marginPrice" 
                                	   name="marginPrice" 
                                	   type="text" 
                                	   class="form-control" 
                                	   style="width:150px" 
                                	   value="${goods.marginPrice }">
                                <span class="input-group-text">원</span>
                                </div>
                              </td>
                            </tr>
                        ...
                        <div class="product-title">
					  	  <div class="product-img-div">
					  		<img class="product-img" 
					  			 src="/zWeaRit/resources/assets/img/uploads/${goods.goodsImgAddr }">
					  	  </div>
						</div>
