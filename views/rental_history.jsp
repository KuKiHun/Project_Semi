     ...
     <table border="1">
	  ...
	  <c:forEach items="${rentList}" var="rent">
            <tr>
                ...
                <td>${order.orderedAmount}</td>
                <td>${rent.rentDate}</td>
                <td>${rent.returnAppointed}</td>
                <td>${rent.returnDate}</td>
                <td>${rent.returnState}</td>
                <td>${rent.ono}</td>
    ...
    <table>
        ...
        <c:forEach items="${orderList}" var="order">
            <tr>
                ...
                <td>
                    <button onclick="cancelOrder(${order.orderNumber})">주문 취소</button>
                </td>
                <td>
                    <button onclick="trackDelivery(${order.orderNumber})">배송 조회</button>
                </td>
            </tr>
        </c:forEach>
    </table>
