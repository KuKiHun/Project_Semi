...
<body class="animsition">
	...
	<table class="table table-bordered txt-center" border="1" style="width:100%; padding:10px; text-align:center;">
			<tr>
				<th bgcolor="#DCD3CB" width="20" >번호</th>
				<th bgcolor="#DCD3CB" width="100">제목</th>
				<th bgcolor="#DCD3CB" width="40">작성자</th>
				<th bgcolor="#DCD3CB" width="50">등록일</th>
				<!-- <th bgcolor="#DCD3CB" width="20">조회수</th> -->
			...
			<c:forEach items="${ postList }" var="post">
				...
				<tr>
					<td>${post.pono }</td>
					<td align="left"><a href="getPost.do?pono=${post.pono }">
						${post.postTitle }</a></td>
		...
		<br> <a href="insertPost.do">새글 등록</a>
