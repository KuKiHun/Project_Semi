...
<!-- Header -->
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" id="bgimage" style="background-image: url('resources/images/bg-01.jpg');">
		...
		<hr>
		<!-- 1. 폼태그에 속성 추가  -->
		<form action="modifyPost.do" method="post" > <!-- enctype="multipart/form-data" -->
		...
		<input name="pono" type="hidden" value="${post.pono}" />
			<table border="1" class="table table-bordered" >
				...
				<tr>
					<td bgcolor="#DCD3CB">작성자명</td>
					<td align="left"><input type="text" size="10" name="postWriter" value=" ${post.postWriter }" ></td>
				</tr>
				<tr>
					<td bgcolor="#DCD3CB">내용</td>
					<td align="left"><textarea cols="40" rows="10" name="postContent">${post.postContent}</textarea></td>
				</tr>
				<!-- 추가항목 시작 -->
				<tr>
					<td bgcolor="#DCD3CB" >비밀번호</td>
					<td align="left"><input type="password" id="postPass" name="postPass" value="${post.postPass }"></td>
				</tr>
